...
from convlab2.policy.rlmodule import MultiDiscretePolicy,MLEPolicy
...
class MLE(MLEAbstract):
    ...
    def __init__(self,
        ...
        #model_file,voc_file+voc_opp_file的长度是num_labels
        self.policy = MLEPolicy(self.vector.state_dim,cfg,self.vector.sys_da_dim).to(device=DEVICE)
